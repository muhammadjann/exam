...
from muhammad.views import HomeView, about_page, AddPost, ArticleDetailView, DeletePostView, user_post, login_page, logout_page, register_page, UpdatePostView
...
urlpatterns = [
    ...
    path('post_conf_delete/', DeletePostView.as_view(), name='post_conf_delete'),
